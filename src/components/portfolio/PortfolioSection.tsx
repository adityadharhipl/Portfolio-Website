          ...
          <div className="px-6 pb-10 pt-8 sm:px-10 lg:px-14 lg:pb-14">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {portfolioProjects.map((project, index) => (
                <article
                  key={project.title}
                  className={`group lift-card overflow-hidden rounded-[1.5rem] border border-[rgba(18,18,18,0.08)] bg-white shadow-[0_18px_45px_rgba(16,18,22,0.08)] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl ${
                    index % 2 === 1
